...
#   filename:  <stdin>
#   timestamp: 2026-06-03T09:18:06+00:00
...
class CvesGetCvesQueryParameters(BaseModelSdk):
    ...
    exploitation_phase: Annotated[
        ...
        Field(description='Filter by exploitation phase', title='Exploitation Phase'),
    ] = None
    page: Annotated[
        Optional[int], Field(description='Page number', ge=1, title='Page')
    ] = 1
...
class CvesGetCveIndicatorsQueryParameters(BaseModelSdk):
    sort_by: Annotated[
        ...
        Field(description='Ranking applied to the returned list.'),
    ] = 'popular'
    indicator_type: Annotated[
        Optional[List[IndicatorType]],
        Field(description='Restrict to one or more IOC types.', title='Indicator Type'),
    ] = None
...
class VendorsGetVendorsQueryParameters(BaseModelSdk):
    query: Annotated[
        Optional[str], Field(description='Search query for vendors', title='Query')
    ] = None
    sort_by: Annotated[
    ...
    sort_order: Annotated[
        Optional[GetCVEsSortOrder],
        Field(description='Sort order: asc or desc', title='Sort Order'),
    ] = 'desc'
    page: Annotated[
        Optional[int], Field(description='Page number', ge=1, title='Page')
    ] = 1
...
class ProductsGetProductsQueryParameters(BaseModelSdk):
    query: Annotated[
        Optional[str], Field(description='Search query for products', title='Query')
    ] = None
    page: Annotated[
        Optional[int], Field(description='Page number', ge=1, title='Page')
    ] = 1
...
class TrackerTagsGetTagsQueryParameters(BaseModelSdk):
    query: Annotated[
        Optional[str], Field(description='Search query for tags', title='Query')
    ] = None
    page: Annotated[
        Optional[int], Field(description='Page number', ge=1, title='Page')
    ] = 1
...
class FingerprintsGetFingerprintRulesQueryParameters(BaseModelSdk):
    query: Annotated[
        Optional[str],
        Field(description='Search query for fingerprint rules', title='Query'),
    ] = None
    sort_by: Annotated[
        Optional[GetCVEsSortBy], Field(description='Field to sort by', title='Sort By')
    ] = 'rule_release_date'
...
class TrackerEventsGetExploitationPhaseChangeEventsQueryParameters(BaseModelSdk):
    ...
    cve_id: Annotated[
        Optional[str],
        Field(description='Filter by CVE identifier (exact match)', title='Cve Id'),
    ] = None
    previous_phase: Annotated[
        Optional[CVEExploitationPhase],
        Field(
    ...
    new_phase: Annotated[
        Optional[CVEExploitationPhase],
        Field(description='Filter by new exploitation phase name', title='New Phase'),
    ] = None
    page: Annotated[
        Optional[int], Field(description='Page number', ge=1, title='Page')
    ] = 1
