...
#   filename:  <stdin>
#   timestamp: 2024-10-09T06:50:59+00:00
...
class IndexItem(BaseModelSdk):
    appsec_configs: Annotated[
        Optional[List[str]],
        Field(
            alias='appsec-configs',
            description='List of appsec-configs in the item (only if type=collection)',
    ...
    appsec_rules: Annotated[
        ...
        Field(
            alias='appsec-rules',
            description='List of appsec-rules in the item (only if type=collection)',
            title='Appsec-Rules',
        ),
    ] = None
    collections: Annotated[
        Optional[List[str]],
        Field(
            description='List of collections in the item (only if type=collection)',
            title='Collections',
        ),
    ] = None
    content: Annotated[
    ...
    contexts: Annotated[
        Optional[List[str]],
        Field(
            description='List of contexts in the item (only if type=collection)',
            title='Contexts',
        ),
    ] = None
    description: Annotated[
    ...
    parsers: Annotated[
        Optional[List[str]],
        Field(
            description='List of parsers in the item (only if type=collection)',
            title='Parsers',
        ),
    ] = None
    path: Annotated[
    ...
    postoverflows: Annotated[
        Optional[List[str]],
        Field(
            description='List of postoverflows in the item (only if type=collection)',
            title='Postoverflows',
        ),
    ] = None
    references: Annotated[
    ...
    scenarios: Annotated[
        Optional[List[str]],
        Field(
            description='List of scenarios in the item (only if type=collection)',
            title='Scenarios',
        ),
    ] = None
    stage: Annotated[
        Optional[str],
        Field(
            description='The stage of the parser/postoverflow, ignored for other types',
            title='Stage',
        ),
    ] = None
    version: Annotated[
...
class Index(RootModel[Optional[Dict[str, Dict[str, IndexItem]]]]):
    root: Optional[Dict[str, Dict[str, IndexItem]]] = None
