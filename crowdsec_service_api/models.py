...
#   filename:  <stdin>
#   timestamp: 2026-06-01T09:58:06+00:00
...
class BlocklistsUploadBlocklistContentQueryParameters(BaseModelSdk):
    expiration: Annotated[
        ...
        Field(
            ...
            examples=['2026-06-01T08:51:54.168480+00:00'],
            title='Expiration',
        ),
    ] = None
...
class IntegrationsGetIntegrationContentQueryParameters(BaseModelSdk):
    ...
    pull_limit: Annotated[Optional[int], Field(title='Pull Limit')] = None
    enable_ip_aggregation: Annotated[
        Optional[bool], Field(title='Enable Ip Aggregation')
    ] = False
...
class DecisionsGetDecisionsQueryParameters(BaseModelSdk):
    instance_ids: Annotated[
        Optional[List[str]],
        Field(description='Filter decisions by instance IDs', title='Instance Ids'),
    ] = []
    tag_ids: Annotated[
        Optional[List[str]],
        Field(description='Filter decisions by tag IDs', title='Tag Ids'),
    ] = []
    ...
    ips: Annotated[
        Optional[List[str]],
        Field(
            description='Filter decisions by IPs (only for IP decisions)', title='Ips'
        ),
    ] = []
    sort_by: Annotated[
        Optional[DecisionsSortBy],
        Field(
            description='Field to sort by (e.g., created_at, duration)', title='Sort By'
        ),
    ] = 'created_at'
