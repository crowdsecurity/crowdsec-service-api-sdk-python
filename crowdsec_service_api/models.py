...
#   filename:  <stdin>
#   timestamp: 2026-09-11T16:23:58+00:00
...
class AggregatedDecisionsSortBy(StrEnum):
...
class BlocklistCreateRequest(BaseModelSdk):
    ...
    store_full_content_in_s3: Annotated[
        Optional[bool],
        Field(
            description='Whether to store the full blocklist content in S3 or not',
            title='Store Full Content In S3',
        ),
    ] = False
...
class DecisionMachineStateEnum(StrEnum):
...
class OperatingSystem(BaseModelSdk):
    name: Annotated[str, Field(title='Name')]
    version: Annotated[str, Field(title='Version')]
    family: Annotated[Optional[str], Field(title='Family')] = None
...
class CapiEntitiesListsSubscriberEntityBlocklistSubscription(BaseModelSdk):
    id: Annotated[str, Field(title='Id')]
    remediation: Annotated[Optional[str], Field(title='Remediation')] = None


class SrcApiV1ModelsIntegrationsBlocklistSubscription(BaseModelSdk):
    id: Annotated[str, Field(title='Id')]
    remediation: Annotated[Optional[str], Field(title='Remediation')] = None
    name: Annotated[str, Field(title='Name')]
    label: Annotated[str, Field(title='Label')]
...
class CVEExploitationPhase(StrEnum):
    ...
    LIMITED_EXPLOITATION = 'limited_exploitation'
...
class BlocklistsUploadBlocklistContentQueryParameters(BaseModelSdk):
    expiration: Annotated[
        ...
        Field(
            ...
            examples=['2026-09-11T16:22:07.038766+00:00'],
            title='Expiration',
        ),
    ] = None
...
class DecisionsGetDecisionsQueryParameters(BaseModelSdk):
    ...
    alert_ids: Annotated[
        Optional[List[str]],
        Field(
            description='Filter decisions by associated alert IDs',
            examples=[['alert-abc123', 'alert-def456']],
            title='Alert Ids',
        ),
    ] = []
    decision_ids: Annotated[
        Optional[List[str]],
        Field(
            description='Filter decisions by decision IDs',
            examples=[['dec-abc123', 'dec-def456']],
            title='Decision Ids',
        ),
    ] = []
    created_at_from: Annotated[
        Optional[datetime],
        Field(
            description='Filter decisions created after this date (inclusive)',
...
class DecisionsGetAggregatedDecisionsQueryParameters(BaseModelSdk):
    page: Annotated[
        Optional[int], Field(description='Page number', ge=1, title='Page')
    ] = 1
    size: Annotated[
    ...
    instance_ids: Annotated[
        ...
        Field(
            description='Filter decisions by instance IDs',
            examples=[['inst-abc123', 'inst-def456']],
            title='Instance Ids',
        ),
    ] = []
    tag_ids: Annotated[
    ...
    ips: Annotated[
        ...
        Field(
            description='Filter decisions by IPs (only for IP decisions)',
            examples=[['203.0.113.7', '198.51.100.42']],
            title='Ips',
        ),
    ] = []
    alert_ids: Annotated[
    ...
    sort_by: Annotated[
        Optional[AggregatedDecisionsSortBy],
        Field(
            description='Field to sort by (e.g., created_at, duration)',
            examples=['created_at'],
            title='Sort By',
...
class DecisionsDeleteAggregatedDecisionsPathParameters(BaseModelSdk):
    aggregated_id: Annotated[str, Field(title='Aggregated Id')]


class DecisionsDeleteAggregatedDecisionItemPathParameters(BaseModelSdk):
    aggregated_id: Annotated[str, Field(title='Aggregated Id')]
    decision_id: Annotated[str, Field(title='Decision Id')]


class EnginesGetEnginesQueryParameters(BaseModelSdk):
    tag: Annotated[
        Optional[List[str]],
        Field(
            description='List of tags associated with the engines (any of)',
            examples=[['web-prod', 'linux']],
            title='Tag',
        ),
    ] = None
    page: Annotated[
...
class BlocklistSubscriptionRequest(BaseModelSdk):
    ...
    ids: Annotated[
        Optional[List[str]],
        Field(
            description='List of subscriber entity id. Must be empty for organization type subscription',
            title='Ids',
        ),
    ] = None
    entity_type: SubscriberEntityType
    remediation: Annotated[
        Optional[str],
        Field(
            description='Remediation, optional for firewall integration and required for other entity types',
            title='Remediation',
        ),
    ] = None


class DecisionMachineState(BaseModelSdk):
    timestamp: Annotated[
        datetime,
        Field(description='Date of when the state has been set', title='Timestamp'),
    ]
    state: Annotated[
        DecisionMachineStateEnum, Field(description='State of the decision')
    ]
...
class EngineGetResponse(BaseModelSdk):
    id: Annotated[str, Field(description='ID of the engine', title='Id')]
    organization_id: Annotated[
        str, Field(description='ID of the owner organization', title='Organization Id')
    ]
    created_at: Annotated[
        datetime, Field(description='Time the engine was created', title='Created At')
    ]
    entity_type: Annotated[
        Optional[EntityType], Field(description='Type of the entity')
    ] = 'engine'
    blocklists: Annotated[
        Optional[List[CapiEntitiesListsSubscriberEntityBlocklistSubscription]],
        Field(title='Blocklists'),
    ] = []
    allowlists: Annotated[
        Optional[List[AllowlistSubscription]], Field(title='Allowlists')
    ] = []
    version: Annotated[Optional[str], Field(title='Version')] = None
    enrolled_at: Annotated[Optional[datetime], Field(title='Enrolled At')] = None
    os: Optional[OperatingSystem] = None
    meta: Annotated[Optional[Dict[str, Any]], Field(title='Meta')] = {}
    last_pull: Annotated[
        Optional[datetime],
        Field(description='Last time the engine pulled CAPI', title='Last Pull'),
    ] = None
    last_push: Annotated[
        Optional[datetime],
        Field(description='Last time the engine pushed to CAPI', title='Last Push'),
    ] = None
    last_login: Annotated[
        Optional[datetime],
        Field(description='Last time the engine logged in CAPI', title='Last Login'),
    ] = None
    tags: Annotated[
        Optional[List[str]],
        Field(description='List of tags associated with the engine', title='Tags'),
    ] = []
    scenarios: Annotated[
        Optional[List[str]],
        Field(
            description='List of scenarios associated with the engine',
            title='Scenarios',
        ),
    ] = None


class EngineGetResponsePage(BaseModelSdk):
    items: Annotated[List[EngineGetResponse], Field(title='Items')]
    total: Annotated[Optional[Total], Field(title='Total')] = None
    page: Annotated[Optional[Page], Field(title='Page')] = None
    size: Annotated[Optional[Size], Field(title='Size')] = None
    pages: Annotated[Optional[Pages], Field(title='Pages')] = None
...
class IntegrationCreateResponse(BaseModelSdk):
    ...
    blocklists: Annotated[
        List[SrcApiV1ModelsIntegrationsBlocklistSubscription],
        Field(
...
class AggregatedDecisionItem(BaseModelSdk):
    id: Annotated[
        str, Field(description='ID of the decision aggregated item', title='Id')
    ]
    first_created_at: Annotated[
        datetime,
        Field(
            description='Creation date of the first decision in the group',
            title='First Created At',
        ),
    ]
    last_created_at: Annotated[
        datetime,
        Field(
            description='Creation date of the last decision in the group',
    ...
    min_duration: Annotated[
        str,
        Field(
            description='Min duration in the group of decisions', title='Min Duration'
        ),
    ]
    max_duration: Annotated[
        str,
        Field(
            description='Max durations in the group of decisions', title='Max Duration'
        ),
    ]
    first_expiration: Annotated[
        datetime,
        Field(
            description='First expiration date in the group of decisions',
            title='First Expiration',
        ),
    ]
    last_expiration: Annotated[
        datetime,
        Field(
            description='Last expiration date in the group of decisions',
            title='Last Expiration',
        ),
    ]
    count: Annotated[
        int, Field(description='Number of decisions in the group', title='Count')
    ]
    machines: Annotated[
        Dict[str, DecisionMachineState],
        Field(
            description='Machines object (the instance ID is the key) with the decision status and timestamp',
            title='Machines',
        ),
    ]
...
class AggregatedDecisionsGetResponse(BaseModelSdk):
    id: Annotated[
        str, Field(description='ID of the decision aggregated item', title='Id')
    ]
    ...
    first_expiration: Annotated[
        Optional[datetime],
        Field(
            description='Expiration date of the first decision in the group',
            title='First Expiration',
        ),
    ] = None
    last_expiration: Annotated[
        Optional[datetime],
        Field(
            description='Expiration date of the last decision in the group',
            title='Last Expiration',
        ),
    ] = None
    decisions: Annotated[
        List[AggregatedDecisionItem],
        Field(description='List of decisions in the group', title='Decisions'),
    ]


class AggregatedDecisionsGetResponsePage(BaseModelSdk):
    items: Annotated[List[AggregatedDecisionsGetResponse], Field(title='Items')]
    total: Annotated[Optional[Total], Field(title='Total')] = None
    page: Annotated[Optional[Page], Field(title='Page')] = None
    size: Annotated[Optional[Size], Field(title='Size')] = None
    pages: Annotated[Optional[Pages], Field(title='Pages')] = None
